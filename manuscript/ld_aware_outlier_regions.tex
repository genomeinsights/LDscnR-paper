...
from seven different bases spanning a sevenfold range in marker count give
comparable discovery counts and permutation significance throughout, with a
sharp loss only when the kinship is left unpruned.
