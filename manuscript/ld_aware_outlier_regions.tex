...
rather than signal, dominates. We validate the method on coalescent simulations,
...
simulated and the real analyses. On the coalescent simulations, where population
...
coalescent simulations---where truth is known---LFMM's region-detection PR-AUC is
