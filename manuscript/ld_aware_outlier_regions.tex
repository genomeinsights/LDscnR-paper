...
kinship is pruned at all. Across region-size filters $\ell_{\min}$, the
complexity-reduction kinship and the deflated below-background kinship
($\lambda = 1.04$ and $0.93$ respectively, over the same ten environments)
