...
\begin{keybox}
\textbf{Which leaves the enrichment difference unexplained.} Long-and-dense holds
...
**The enrichment therefore remains unexplained**, and three mechanisms are on the
record as refuted rather than deleted: demographically manufactured long-range LD
