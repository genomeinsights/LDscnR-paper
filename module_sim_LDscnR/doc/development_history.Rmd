...
What remains is a threefold per-marker concentration in long dense blocks and a
fourfold depletion in long sparse ones, neither of which has a mechanism, and
both of which are small enough that "clusters with more markers contain more
QTN" is close to a complete account.
